...
% In the second experiment (Fig~\ref{fig:experiment_5}), period-$2$ cycles occur for every initial profile. To our surprise, while we expected cycles with different energies, the energy level between the alternating profiles of a particular cycles is relatively small.

\begin{figure*}[h]
    \begin{subfigure}[b]{0.6\textwidth}
    \includegraphics[width=\textwidth]{code/figs/fig2.png}
    \caption{}
    \label{fig:2a}
    \end{subfigure}
    \hfill
    ...
    \centering
    \includegraphics[width=0.8\textwidth]{code/figs/fig2b.png}
    \caption{}
    \label{fig:2b}
    \end{subfigure}
